...
impl SvgTag {
    ...
    pub fn x<V: Display>(mut self, v: V) -> Self {
        self.property("x", v)
    }

    pub fn y<V: Display>(mut self, v: V) -> Self {
        self.property("y", v)
    }

    pub fn w<V: Display>(mut self, v: V) -> Self {
        self.property("width", v)
    }

    pub fn h<V: Display>(mut self, v: V) -> Self {
...
mod tests {
    ...
    #[test]
    fn it_works() {
        let a = SvgTag::new("svg").w("60px").h("80px").child(SvgTag::new("rect").x(5).y(5).w(50).h(20));
